setwd("C:/Users/Ashwin/OneDrive/Desktop/BA w R/Project presentation")
rm(list=ls())
...
corr_map <- ggcorr(df[, 1:10], method=c("everything", "pearson"), label=TRUE, hjust = .90, size = 3, layout.exp = 2)
corr_map
